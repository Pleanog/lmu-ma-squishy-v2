...
Messages.empty_field = "Eines der Felder war leer"
...
Messages.wrong_username_format = "Fehler: Ihr Benutzername muss in der " \
...
Messages.wired = "eduroam auch für kabelgebundenes Ethernet " \
    "einrichten?\n\n Beachten Sie hierbei, dass dadurch " \
    "Verbindungsverzögerungen von bis zu 30 Sekunden entstehen können, " \
    "wenn Sie sich mit einem offenen kabelgebundenen Netzwerk verbinden " \
    "möchten."
Config.instname = "Ludwig-Maximilians-Universität München (LMU)"
Config.profilename = "eduroam-campus.lmu.de"
Config.url = "https://servicedesk.lrz.de"
Config.email = "servicedesk@lrz.de"
Config.title = "eduroam CAT"
Config.server_match = "radius.lrz.de"
...
Config.user_realm = "campus.lmu.de"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.lrz.de']
Config.servers_cn = 'radius.lrz.de'
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymouscat@campus.lmu.de"
Config.tou = ""
Config.wired = ""
